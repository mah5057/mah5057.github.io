...
Making this change. Creating a new database deployment in your mLab account is a simple process after you've [determined which plan you need][docs-plans]. Once you've subscribed to a plan, you can make changes to the deployment or delete it when you do not need it any longer.
